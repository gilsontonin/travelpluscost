...
2. **Vet by volume + KD — band, not gate (go broad).** Take low-KD quick wins AND juicy high-KD pillars (topical authority). Pull the next from the keyword map (`blog:map`). *Quick-win wins:* Branson KD 18/480, Telluride KD 21/480, Charleston KD 28/1,300. See `References/KeywordResearch.md`.
