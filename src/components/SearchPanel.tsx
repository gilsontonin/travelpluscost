...
export default function SearchPanel({
  ...
  if (compact && !open) {
    ...
    return (
      <div className="flex w-full items-center gap-3 rounded-2xl border border-black/[0.08] bg-card px-4 py-2.5 shadow-card transition hover:border-black/25">
  ...
  return (
    <div className={`${compact ? "" : "mx-auto max-w-xl"} bg-white rounded-2xl border border-black/5 shadow-sm p-3 sm:p-4`}>
      ...
      <form onSubmit={submit} className="space-y-2.5">
        ...
        <button
          type="submit"
          className="relative z-[60] w-full bg-accent text-white font-semibold py-3.5 rounded-full flex items-center justify-center gap-2 hover:opacity-90 active:scale-[0.99] transition"
        >
