...
import HotelAreaSnippet from "@/components/HotelAreaSnippet";
...
export default async function HotelPage({ params }: { params: Promise<{ city: string; slug: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pt-3 pb-24 sm:py-6 lg:pb-6">
      ...
      <Reviews hotel={hotel} />
      <HotelAreaSnippet city={hotel.city} lat={hotel.lat} lng={hotel.lng} name={hotel.name} citySlug={slugify(hotel.city ?? "")} />
